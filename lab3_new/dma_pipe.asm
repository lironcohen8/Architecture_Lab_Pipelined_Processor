	...
	asm_cmd(JLT, 0, 2, 5, 7); // 10: if R2 < R5 jump to line 7 // Data Hazard
	...
	asm_cmd(ST, 0, 4, 4, 1010); // 18: dummy instruction - Structural Hazard
	...
	asm_cmd(JLT, 0, 3, 5, 17); // 25: if R3 < R5 jump to line 17 // Control Hazard
